<footer class="dg-footer" style="background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/assets/dist/images/Geral/footer.png');background-repeat: no-repeat;background-size: cover; background-position: center; background-repeat: no-repeat; background-size: cover;">
    <div class="dg-grid">
        <div class="col-um">
            ...
            <p>As aulas tem duração de 60 minutos e estão sendo ministradas no Estúdio Invertpolefit.
                Neste momento são aulas para no máximo 4 pessoas, mantendo a segurança do aluno
                e proporcionando uma aula personalizada.</p>
        </div>
        <div class="col-dois">
            <strong>
                Ultimos Posts
            ...
            <div class="links">
                <a href="https://jacyoga.com/yoga-para-todos/">Yoga para todos</a>
            </div>
            <div class="links">
                <a href="https://jacyoga.com/caracteristicas-dos-asanas/">Caracteristicas dos Ásanas</a>
            </div>
            <div class="links">
                <a href="https://jacyoga.com/a-base-do-metodo-jacyoga/">A base do método Jacyoga</a>
            </div>
        </div>
        <div class="col-tres">
            ...
            <div class="redes">
                <div class="face">
                 <a href=""><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/dist/images/Geral/facebook.png" alt=""></a>   
                </div>
                <div class="insta">
                  <a href=""><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/dist/images/Geral/instagram.png" alt=""></a>  
                </div>
            </div>
        </div>
    </div>
